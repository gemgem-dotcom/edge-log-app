...
// numbers, and standard special characters - this keeps sign up, the
...
// Standard special characters allowed alongside letters and digits.
const PASSWORD_PATTERN = /^[A-Za-z0-9!@#$%^&*()_+\-=\[\]{}|;:,.<>?]{8,15}$/

export const PASSWORD_REQUIREMENTS_TEXT =
  'Password must be 8-15 characters and can only contain letters, numbers, and standard special characters (!@#$%^&*()_+-=[]{}|;:,.<>?).'
