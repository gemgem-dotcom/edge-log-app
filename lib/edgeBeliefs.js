...
// touch on save/edit/delete. Extracted as its own function so §3 (regime
// bucketing) has a single, obvious place to add volatility_regime/
// volume_regime and their strategy_id intersections later.
function slicesForTrade(trade) {
  return singleDimensionSlices(trade)
}
