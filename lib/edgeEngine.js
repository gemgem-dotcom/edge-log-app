...
// two. strategy_id leads its three composites for the same reason -
// "where does THIS strategy work" is the more useful starting point than
// "how does this condition generally perform, across every strategy."
// session leads day_of_week for the same kind of call - market structure
// (session) as the primary axis, personal timing (day_of_week) refining
// it - though unlike the other pairs above, both sides here are already
// independently informative, so this one's a closer call than the others.
