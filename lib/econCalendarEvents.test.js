...
describe('normalizeFeedEvent', () => {
  ...
  // FF files global events (OPEC, G20) under country "All". It has to
  // survive normalising AND be in CURRENCIES, or the card can never show it.
  it('keeps the feed\'s "All" currency and keeps it filterable', () => {
