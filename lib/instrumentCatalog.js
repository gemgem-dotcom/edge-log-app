...
export const INSTRUMENT_CATALOG = [
  ...
  // 0.1 BTC per contract, so a 1.00 move in price is $0.10 — not the $0.50
  // tick value, which covers a 5-point tick.
  { symbol: 'MBT', display_name: 'Micro Bitcoin', data_symbol: 'BTC', point_value: 0.1 },
]
