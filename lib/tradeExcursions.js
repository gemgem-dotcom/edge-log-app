...
// matching tick at or after `afterInstant` (omit for entry, which has no
// lower bound beyond the fetch window's own start) among every tick in the
// already-fetched, padded set (see FILL_SEARCH_PAD_MINUTES).
//
...
// at or after `afterInstant` matches - a genuine miss, not assumed to be
