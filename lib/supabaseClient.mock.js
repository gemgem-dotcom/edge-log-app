...
const MOCK_ECONOMIC_EVENTS = (() => {
  ...
  const rows = [
    [1, 10, 0, 'Fed Chair Powell Speaks', 'USD', 'medium', 'Speeches', null, null, null],
    [1, 14, 0, '10-y Bond Auction', 'USD', 'low', 'Bonds', null, '4.28%', null],
    [2, 8, 30, 'CPI m/m', 'USD', 'high', 'Inflation', '0.3%', '0.2%', '0.4%'],
    [2, 10, 0, 'CB Consumer Confidence', 'USD', 'medium', 'Consumer Surveys', '98.5', '97.2', null],
    [2, 4, 30, 'Official Bank Rate', 'GBP', 'high', 'Central Bank', '4.75%', '5.00%', null],
    [3, 8, 30, 'Unemployment Claims', 'USD', 'medium', 'Employment', '224K', '221K', null],
    [3, 10, 30, 'Crude Oil Inventories', 'USD', 'low', 'Misc', '-1.2M', '2.4M', null],
    [3, 5, 0, 'German Ifo Business Climate', 'EUR', 'medium', 'Business Surveys', '86.1', '85.4', null],
    [4, 8, 30, 'Retail Sales m/m', 'USD', 'high', 'Growth', '0.4%', '0.6%', null],
    [4, 10, 0, 'Existing Home Sales', 'USD', 'medium', 'Housing', '3.95M', '3.83M', null],
    [4, 21, 30, 'Employment Change', 'AUD', 'high', 'Employment', '25.2K', '15.9K', null],
    [5, 0, 0, 'Bank Holiday', 'JPY', 'holiday', 'Misc', null, null, null],
    ...
    [4, 7, 0, 'OPEC-JMMC Meetings', 'ALL', 'medium', 'Misc', null, null, null],
    [5, 8, 30, 'Core PCE Price Index m/m', 'USD', 'high', 'Inflation', '0.2%', '0.3%', null],
  ]
  return rows.map(([day, hh, mm, title, currency, impact, event_type, forecast, previous, actual]) => {
