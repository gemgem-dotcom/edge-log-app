...
// down (0.4-0.62, then 0.3-0.5) still read as too solid once scrolled
// past FADE_DISTANCE and pinned at MAX - this range keeps the blurred
// backdrop (see .topbar-pinned's backdrop-filter) as the dominant visual
// contributor even at MAX, while MIN still keeps enough of its own tint
// to stay legible over busy scrolled content right as it reveals.
const FADE_DISTANCE = 320
const MIN_GLASS_ALPHA = 0.22
const MAX_GLASS_ALPHA = 0.36
