...
// this layout's own add-strategy, and app/app/page.js's onboarding (insert
// a strategy), and the strategy detail + strategies-management pages
// (rename/archive/delete one). Treat adding a new write path to either
