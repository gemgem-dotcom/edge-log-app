...
// through it, right where the pinned bar most needs to stay readable.
// Raised well past --glass's decorative-panel tint: a nav bar overlaying
// arbitrary scrolled content needs enough of its own backdrop to stay
// legible regardless of what's under it, not just a hint of blur.
const FADE_DISTANCE = 320
const MIN_GLASS_ALPHA = 0.55
const MAX_GLASS_ALPHA = 0.82
