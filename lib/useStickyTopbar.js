...
// flat solid panel with faint edge-ghosting. This middle range keeps
// enough backdrop showing through for the blur (see .topbar-pinned's now
// heavier backdrop-filter) to actually diffuse into visible soft texture,
// while staying far short of the original's illegible transparency.
const FADE_DISTANCE = 320
const MIN_GLASS_ALPHA = 0.4
const MAX_GLASS_ALPHA = 0.62
