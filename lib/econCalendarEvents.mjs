...
//
// This is a stated assumption, not a silent one. lib/econCalendarHtml.mjs
// checks it against each page's own data-day-dateline (the epoch of local
// midnight) before trusting it for the arithmetic, and falls back rather
// than applying a correction derived from a zone FF has moved off.
