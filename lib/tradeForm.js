...
export function validateSetup({ strategyId, trade_date, trade_time, entry, direction, target_distance, stop_distance }) {
  ...
  // The input's max attribute only constrains the native picker, and the
  // form sets noValidate, so a typed or pasted future date has to be caught
  // here. ISO dates compare correctly as strings.
